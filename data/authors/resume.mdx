...
Experienced product and go-to-market strategist with a record of approaching business questions through an analytical lens and driving action through that analysis.
|                                               |                                                   |
| --------------------------------------------- | --------------------------------------------------|
| Product research and strategy development     | Executive presentation and public speaking        |
...
Lead go-to-market messaging, campaign planning, and launches for all of Segment’s core features and its data infrastructure innovation initiative. Collaborate with Product Management on product strategy, product roadmap, and product design docs.
* Collaborated with Product Management on product strategy, product roadmap, and product design docs. I’ve significantly influenced what we are building for release in the next year and the plan for the next 3 years. I primarily work with PM, more than PMM or Marketing.
* Came up with and co-wrote the first two blog posts in a thought leadership series about the modern data stack (first post, second post). Collaborated with PM to build a strategy around the content and distribute writing across our team of subject matter experts in R&D.
...
Led go-to-market strategy and execution for New Relic open source site and the launch of their open source instrumentation. Collaborated closely with Product Management, Engineering, and Solutions Engineering to identify opportunities for open source contribution that could lead to publicity for the company.
...
Collaborated with business users from inventory management, sales, logistics, accounting, and finance to design, development, and delivery of enhancements to the company’s Microsoft Dynamics ERP system. Designed and built reports and led reporting infrastructure development.
...
* **Interests:**  Brazilian Jiu Jitsu brown belt, photographer, and former marathoner (including Boston 2009).
