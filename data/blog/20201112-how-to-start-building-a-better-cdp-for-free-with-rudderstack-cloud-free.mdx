...
tags: ['rudderstack', 'product-launch', 'cdp', 'data', 'tutorial']
draft: false
...
**_This post was originally published on [dev.to](https://dev.to/rudderstack/how-to-start-building-a-better-cdp-for-free-with-rudderstack-cloud-free-ghn). I wrote this as part of a product launch for RudderStack Cloud Free, their free tier._**
<br />
