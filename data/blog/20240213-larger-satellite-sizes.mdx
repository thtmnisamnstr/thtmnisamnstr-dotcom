...
date: '2024-02-13 17:00'
tags: ['earthly', 'product-launch']
draft: false
summary: "Introducing larger instance sizes for Earthly Satellites. These new sizes are designed to give users more compute power, more RAM, more cache storage, and more flexibility in choosing the right satellites for their builds."
images: ['/static/images/blog/20240213-larger-satellite-sizes/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/larger-satellite-sizes/)._**
<br />
...
![close](/static/images/blog/20240213-larger-satellite-sizes/close.png)\
...
![f2f](/static/images/blog/20240213-larger-satellite-sizes/f2f.png)\
