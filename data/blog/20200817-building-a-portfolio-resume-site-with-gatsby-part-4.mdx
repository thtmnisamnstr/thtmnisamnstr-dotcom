...
images: ['/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/devcommunity-logo.png']
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/qev5to3cngk6gctajulo.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/7119wnbb52nnr170fo82.png)
* You should get a login successful screen *(you can close this window)*
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/6bfiacdj67lu9phomm5k.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/qf26ea3sqkmkb0fx18on.png)
* Click Secrets in the left navigation menu
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/i1tpejugaqcm03zrlvek.png)
* Click the New Secret button
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/ahn7c1xx6kprsdwc82im.png)
* For Name, enter 'FIREBASE_TOKEN'
* For Value, enter the Firebase token you copied earlier from Terminal
* Click the Add Secret button
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/2osv1el57qf0ifh324tw.png)

You should see the new secret in your GitHub repo. Here's mine.
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/y4na2bioqao76wln0b0o.png)

### Add GitHub Actions to automate deployment
* In your site's repo in GitHub, click on Actions navigation tab
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/gzaga031obxa67oao9le.png)
* Click the Setup this Workflow button under the Simple Workflow section
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/ijr64ycxemezibhnk7da.png)
* Change your Actions YAML name and click the Start Commit button *(I named mine `build-deploy.yml`)*
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/92tki6q1gjvzwvq7je4z.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/1dsw9bdxil90ghhpyvg9.png)
* Copy the text and paste it at the top of your `build-deploy.yml` file
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/eikmpay183klaz508548.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/wnenrpf5knae8ljcju8g.png)
* Copy the text and paste it at the top of your `build-deploy.yml` file below the Gatsby action you pasted earlier
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/uerbwftuzm5l3jrtze9b.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/fq73mia7fcfivp5bnbax.png)
...
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/8dye812u7jt007l5njjw.png)
* Click on the most recent run of your Action. *It might be a failure. It doesn't matter, just click it.*
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/0a283rsedbwgausmzn7g.png)
* Click Re-run jobs > Re-run all jobs.
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/npn9ydkeav2alt2q4ilc.png)
* Your Action will queue, then run. Its status will change to In Progress and the spinners will start spinning.
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/glltnvb80dsykbibb1va.png)
* If you click on the Action in the left nav panel, you can see it run (or troubleshoot failures).
![Alt Text](/static/images/blog/20200817-building-a-portfolio-resume-site-with-gatsby-part-4/r9eibt6stszw7jct88kl.png)
