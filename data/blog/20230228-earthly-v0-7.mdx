...
tags: ['earthly', 'product-launch', 'ci-cd', 'release-notes']
draft: false
summary: "Announcing the release of Earthly v0.7. The new version introduces changes that make Earthly work natively with Earthly CI in addition to adding Podman support, the WAIT command, and several other features."
images: ['/images/blog/20230228-earthly-v0-7/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/earthly-v0-7/). It was part of a coordinated launch for Earthly CI that included the blog posts '[Earthly CI: Launching a new era for CI](https://earthly.dev/blog/launching-earthly-ci/)', '[Announcing Earthly’s $6.5M Seed+ round](https://earthly.dev/blog/new-fundings-at-earthly/)', and '[Remote Code Execution as a Service](https://earthly.dev/blog/remote-code-execution/) as well as [a press release](https://www.businesswire.com/news/home/20230223005033/en/With-6.5M-in-New-Funding-Earthly-Introduces-Fast-Repeatable-Easy-to-Use-SaaS-CICD-Platform), [a blog post by Innovation Endeavors](https://medium.com/innovationendeavors/simple-fast-repeatable-builds-f9b1eac9446f), Earthly lead investors in the announced funding round, and [coverage by TechCrunch](https://techcrunch.com/2023/02/23/earthly-wants-to-reinvent-continuous-integration-to-make-it-faster-and-cheaper/)._**
<br />
