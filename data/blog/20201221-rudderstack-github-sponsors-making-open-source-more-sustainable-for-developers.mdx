...
draft: false
summary: "Announcing our launch partnership with GitHub for GitHub Sponsors for companies."
images: ['/images/blog/20201221-rudderstack-github-sponsors-making-open-source-more-sustainable-for-developers/hero.png']
authors: ['gavin-johnson']
---

**_This post was originally published on [RudderStack's blog](https://rudderstack.com/blog/RudderStack-gitHub-sponsors-making-open-source-more-sustainable-for-developers). I wrote this as part of a formal announcement for RudderStack's GitHub Sponsors program._**
<br />
