...
images: ['/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/hero.jpg']
...
2. Click the Create a Free Cluster button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/001.png)

3. Select Yugabyte Cloud Free and click the Next button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/002.png)

4. Select a cloud provider for your cluster, name your cluster, select a region, and click the Next button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/003.png)
...
5. Copy the default admin credentials by clicking the Copy Credentials link. Then check the “I have copied the admin credentials” checkbox and click the Create Cluster button.
    ...
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/004.png)

6. Wait for your cluster to be provisioned. Click on “Add IP Allow List” in the top section of the Clusters page.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/005.png)

7. Click the Create New List and Add to Cluster button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/006.png)
...
8. In the Name text box, enter “all-ips”. In the IP Address(es) or Range text box, enter “0.0.0.0/0”. Click the Save button. This will allow traffic from all IP addresses to your cluster.
    ...
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/007.png)
...
4. In Yugabyte Cloud, click on “Connect”. Click on Connect to your Application.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/008.png)
...
5. Save your host address and port (highlighted in the screenshot below) for later. Click the Back link in the Connect to Cluster navigation breadcrumb.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/009.png)
...
7. Leave the default Database Name, Database User Name, and API Type. Click the Confirm button. This will launch the Cloud Shell.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/010.png)
...
9. Go to [http://localhost:8080](http://localhost:8080/). The PetClinic sample application should be available.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/011.png)
...
2. Type “artifact registry” in the search bar and click on “Artifact Registry”.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/012.png)

3. Click on the Enable button for the Artifact Registry API.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/013.png)

4. Click Create Repository.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/014.png)

5. Give your repository a Name, make sure Docker is selected for Format, and choose a Region. Click the Create button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/015.png)


6. Click into your new repository and copy its URL.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/016.png)
...
9. Push your PetClinic image to your repo in Artifact Registry: `docker push [repo_url]/spring-petclinic:latest`.
    ...
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/017.png)

10. Type “gke” in the search bar and click on “Kubernetes Engine”.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/018.png)

11. Click on the Enable button for the Kubernetes Engine API.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/019.png)

12. Click Create.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/020.png)

13. Click the Configure button under Autopilot.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/021.png)

14. Enter a Name, select a Region, and click the Create button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/022.png)

15. After your cluster has been created, click on Workloads in the left-navigation panel.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/023.png)

16. Click on Deploy.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/024.png)

17. Select Existing Container Image and click Select in the Image Path.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/025.png)

18. Click on Artifact Registry, expand the folders out, select the image under `spring-petclinic`, and click the Select button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/026.png)
...
19. Click the Add Environment Variable button and enter:
    ...
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/027.png)
...
21. Enter a Name for your application and click the Deploy button (everything else should be auto-filled).
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/028.png)

22. After your workload is deployed, click Expose on the Deployment Details.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/029.png)

23. Set Port to 80, Target Port to 8080 and Service Type to Load Balancer. Click the Expose button.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/030.png)

24. After the load balancer is created, the Service Details page displays.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/031.png)
...
25. If you click on the External Endpoints link ([http://34.105.123.45/](http://34.105.123.45/)), the PetClinic sample application should be available.
    ![alt_text](/static/images/blog/20210902-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-google-kubernetes-engine/032.png)
