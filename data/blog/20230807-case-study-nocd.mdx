...
date: '2023-08-07 17:00'
tags: ['earthly', 'ci-cd', 'earthly-cloud']
draft: false
summary: "Learn how NOCD, a leading telehealth provider, reduced their CI build times by 9x using Earthly and Earthly Cloud."
images: ['/images/blog/20230807-case-study-nocd/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/case-study-nocd/)._**
<br />

![NOCD Logo](/images/blog/20230807-case-study-nocd/nocd.png)
## Highlights
