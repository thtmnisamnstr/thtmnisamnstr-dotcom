...
tags: ['earthly', 'security', 'compliance']
draft: false
summary: "Earthly achieves SOC 2 Type 1 compliance, exhibiting its commitment to data security and user trust in its SaaS offerings"
images: ['/images/blog/20230405-soc-type-one/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/soc-type-one/)._**
<br />
...
![alt_text](/images/blog/20230405-soc-type-one/SOC_NonCPA.png)
</div>
