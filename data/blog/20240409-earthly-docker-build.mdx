...
date: '2024-04-09 17:00'
tags: ['earthly', 'product-launch']
draft: false
summary: "Introducing Earthly docker-build: a new feature that enables Dockerfile-based builds with Earthly and speeds them up by giving you a persistent BuildKit cache that can be used with any CI."
images: ['/static/images/blog/20240409-earthly-docker-build/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/earthly-docker-build/)._**
<br />
...
![Announcing](/static/images/blog/20240409-earthly-docker-build/announce.png)\
...
![Sign](/static/images/blog/20240409-earthly-docker-build/sign.png)\
