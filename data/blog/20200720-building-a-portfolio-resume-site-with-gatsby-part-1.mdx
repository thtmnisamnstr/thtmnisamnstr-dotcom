...
**_This post is the first in a series and was originally published on [Dev.to](https://dev.to/thtmnisamnstr/building-a-portfolio-resume-site-with-gatsby-part-1-setting-up-your-environment-and-creating-a-local-themed-site-aho)._**
<br />
