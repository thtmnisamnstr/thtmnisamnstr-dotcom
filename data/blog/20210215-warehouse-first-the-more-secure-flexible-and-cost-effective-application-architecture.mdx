...
draft: false
summary: "Know what the warehouse-first architecture is, how it works, and whether warehouse-first is the way to go for your data stack."
images: ['/images/blog/20210215-warehouse-first-the-more-secure-flexible-and-cost-effective-application-architecture/hero.png']
authors: ['gavin-johnson']
---

**_This post was originally published on [RudderStack's blog](https://rudderstack.com/blog/warehouse-first-the-more-secure-flexible-and-cost-effective-application-architecture)._**
<br />
