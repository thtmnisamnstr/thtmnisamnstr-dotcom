...
tags: ['earthly', 'tutorial', 'ci-cd']
draft: false
summary: "Learn to optimize dependency caching in Earthfiles to improve build efficiency. The blog explains structuring Earthfiles, breaking down file copying, and reusing dependencies to maximize Earthly's caching capabilities, speeding up builds."
images: ['/images/blog/20240521-efficiently-cache-dependencies-earthfiles/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/efficiently-cache-dependencies-earthfiles/)._**
<br />
...
![Structure](/images/blog/20240521-efficiently-cache-dependencies-earthfiles/structure.png)
