...
excerpt: My personal website sucks. So I'm going to update it using Gatsby.
---
...
![Alt Text](./images/7vq44fvx5kehvo54rkol.png)
...
![Alt Text](./images/klqh120pdq2x1p2bagga.png)
  * Click on Branches in the Settings nav
![Alt Text](./images/xa2mirvatku9wna7ln2e.png)
  * Click the default branch dropdown (currently Master) and select Main
![Alt Text](./images/jgoftnplyfdl765g2tlc.png)
  * Click the Update button
![Alt Text](./images/bzsdp1nics2fciynedcd.png)
  * A warning modal will pop-up. Click the "I understand, update the default branch" button
![Alt Text](./images/alz90bm21kdfxfn7x29o.png)
