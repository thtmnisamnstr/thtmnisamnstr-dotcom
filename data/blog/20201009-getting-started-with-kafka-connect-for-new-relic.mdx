...
images: ['/images/blog/20201009-getting-started-with-kafka-connect-for-new-relic/nr-confluent.png']
authors: ['gavin-johnson','rahul-bhattacharya']
---

**_This post was originally published on [Confluent's blog](https://www.confluent.io/blog/kafka-connect-for-new-relic/) as part of a small go-to-market for the Kafka Connector for New Relic. It was republished on the [New Relic blog](https://blog.newrelic.com/product-news/kafka-connect-for-new-relic/). I co-wrote this post with Rahul Bhattacharya from Confluent._**
<br />
...
![Alt Text](/images/blog/20201009-getting-started-with-kafka-connect-for-new-relic/diagram.png)
...
![Alt Text](/images/blog/20201009-getting-started-with-kafka-connect-for-new-relic/query-builder-1.png)
...
![Alt Text](/images/blog/20201009-getting-started-with-kafka-connect-for-new-relic/query-builder-2.png)
