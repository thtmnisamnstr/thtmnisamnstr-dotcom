...
tags: ['yugabyte', 'tutorial', 'kubernetes']
draft: false
...
images: ['/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/hero.jpg']
...
2. Click the Create a Free Cluster button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/001.png)

3. Select Yugabyte Cloud Free and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/002.png)

4. Select a cloud provider for your cluster, name your cluster, select a region, and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/003.png)
...
5. Copy the default admin credentials by clicking the Copy Credentials link. Then check the “I have copied the admin credentials” checkbox and click the Create Cluster button.
    ...
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/004.png)

6. Wait for your cluster to be provisioned. Click on “Add IP Allow List” in the top section of the Clusters page.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/005.png)

7. Click the Create New List and Add to Cluster button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/006.png)
...
8. In the Name text box, enter “all-ips”. In the IP Address(es) or Range text box, enter “0.0.0.0/0”. Click the Save button. This will allow traffic from all IP addresses to your cluster.
    ...
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/007.png)
...
4. In Yugabyte Cloud, click on “Connect”. Click on Connect to your Application.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/008.png)
...
5. Save your host address and port (highlighted in the screenshot below) for later. Click the Back link in the Connect to Cluster navigation breadcrumb.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/009.png)
...
7. Leave the default Database Name, Database User Name, and API Type. Click the Confirm button. This will launch the Cloud Shell.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/010.png)
...
9. Go to [http://localhost:8080](http://localhost:8080/). The PetClinic sample application should be available.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/011.png)
...
2. Type “ecr” in the search bar and click on “Elastic Container Registry”.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/012.png)

3. Create a repository by clicking the Get Started button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/013.png)

4. Enter a repository name and click the Create Repository button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/014.png)
...
7. Push your PetClinic image to your repo in ECR: `docker push [aws_acct_id].dkr.ecr.[aws_region].amazonaws.com/spring-petclinic:latest`.
    ...
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/015.png)

8. Type “cloudformation” in the search bar and click on “CloudFormation”.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/016.png)

9. Click on Create Stack -> Create stack, With new resources (standard).
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/017.png)
...
10. For Prepare Template, select Template is Ready. For Template Source, select Amazon S3 URL. For Amazon S3 URL, enter “https://s3.us-west-2.amazonaws.com/amazon-eks/cloudformation/2020-10-29/amazon-eks-vpc-private-subnets.yaml”. Click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/018.png)

11. Enter a Stack Name, and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/019.png)

12. On the Configure Stack Options page, click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/020.png)

13. Review your VPC stack and click the Create Stack button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/021.png)

14. After your stack is created, type “eks” in the search bar and click on “Elastic Kubernetes Service”.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/022.png)

15. Under “Create EKS cluster” enter a cluster name and click the Next Step button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/023.png)

16. Select a Cluster Service Role and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/024.png)
...
17. Under Networking, choose the VPC you just created (that should automatically choose the appropriate subnets) and the two security groups that are available. Under Cluster Endpoint Access, choose Public and Private. Click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/025.png)

18. Select nothing for Configure Logging and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/026.png)

19. Review your EKS cluster and click the Create button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/027.png)
...
20. After your cluster has been created, go to the Configuration tab and the Compute tab under it. Click on the Add Node Group button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/028.png)

21. Give your node group a Name, select an IAM Role, and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/029.png)

22. Set your compute and scaling options and click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/030.png)

23. Your subnets should automatically be selected. Click the Next button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/031.png)

24. Review the details of your node group and click the Create button.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/032.png)
...
29. If you go to the External IP address listed ([http://ad7029ef94fed4c06a25897baf9e3c31-1572590571.us-west-1.elb.amazonaws.com/](http://ad7029ef94fed4c06a25897baf9e3c31-1572590571.us-west-1.elb.amazonaws.com/)), the PetClinic sample application should be available.
    ![alt_text](/images/blog/20210827-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-on-amazon-elastic-kubernetes-service/033.png)
