...
images: ['/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/hero.jpg']
...
2. Click the Create a Free Cluster button.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/001.png)

3. Select Yugabyte Cloud Free and click the Next button.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/002.png)

4. Select a cloud provider for your cluster, name your cluster, select a region, and click the Next button.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/003.png)
...
5. Copy the default admin credentials by clicking the Copy Credentials link. Then check the “I have copied the admin credentials” checkbox and click the Create Cluster button.
    ...
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/004.png)

6. Wait for your cluster to be provisioned. Click on “Add IP Allow List” in the top section of the Clusters page.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/005.png)

7. Click the Create New List and Add to Cluster button.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/006.png)
...
8. In the Name text box, enter “all-ips”. In the IP Address(es) or Range text box, enter “0.0.0.0/0”. Click the Save button. This will allow traffic from all IP addresses to your cluster.
    ...
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/007.png)
...
4. In Yugabyte Cloud, click on “Connect”. Click on Connect to your Application.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/008.png)
...
5. Save your host address and port (highlighted in the screenshot below) for later. Click the Back link in the Connect to Cluster navigation breadcrumb.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/009.png)
...
7. Leave the default Database Name, Database User Name, and API Type. Click the Confirm button. This will launch the Cloud Shell.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/010.png)
...
9. Go to [http://localhost:8080](http://localhost:8080/). The PetClinic sample application should be available.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/011.png)
...
![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/012.png)
...
8. If you go to the local IP and Port you configured in your yaml ([http://127.0.0.1:8080](http://127.0.0.1:8080/)), the PetClinic sample application should be available.
    ![alt_text](/images/blog/20210917-connecting-a-spring-boot-application-to-yugabyte-cloud-and-deploying-it-to-kubernetes-on-minikube/013.png)
