...
draft: false
summary: "RudderStack Transformations New Feature Set Launch - RudderStack Transformations are easy to build, debug, and manage; and they run in real-time. They’re data transformations that work like you think they should."
images: ['/images/blog/20210413-the-future-of-data-pipeline-tools-must-include-better-transformations-than-etl-ever-had/hero.png']
authors: ['gavin-johnson']
---

**_This post was originally published on [RudderStack's blog](https://rudderstack.com/blog/the-future-of-data-pipeline-tools-must-include-better-transformations-than-etl-ever-had)._**
<br />
...
![Create a New Transformation](/images/blog/20210413-the-future-of-data-pipeline-tools-must-include-better-transformations-than-etl-ever-had/Transformationslaunch1.png)
...
![Real-Time Debugger](/images/blog/20210413-the-future-of-data-pipeline-tools-must-include-better-transformations-than-etl-ever-had/Transformationslaunch2.png)
