...
draft: false
summary: "Introducing Auto-Skip: a new feature of Earthly Cloud that speeds up builds by smartly skipping entire build targets when appropriate, making builds run even faster."
images: ['/static/images/blog/20240326-auto-skip/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/auto-skip/)._**
<br />
...
![What](/static/images/blog/20240326-auto-skip/what.png)\
...
![How](/static/images/blog/20240326-auto-skip/how.png)\
