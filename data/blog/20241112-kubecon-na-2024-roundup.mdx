...
tags: ['pulumi', 'kubernetes', 'platform-engineering', 'devops']
draft: false
summary: "Inspired by KubeCon North America 2024, this post presents a collection of recent Kubernetes-focused updates to Pulumi software"
images: ['/images/blog/20241112-kubecon-na-2024-roundup/header.png']
authors: ['gavin-johnson']
---
**_This post was originally published on [Pulumi's blog](https://www.pulumi.com/blog/kubecon-na-2024-roundup/)._**
<br />
