...
draft: false
summary: "Earthly achieves SOC 2 Type 2 compliance, further exhibiting its commitment to data security and user trust in its SaaS offerings."
images: ['/images/blog/20240312-soc-type-two/header.jpg']
authors: ['gavin-johnson']
---
**_This post was originally published on [Earthly's blog](https://earthly.dev/blog/soc-type-two/)._**
<br />
