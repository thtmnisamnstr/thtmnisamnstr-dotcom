...
summary: "This blog summarizes the latest RudderStack features and bug fixes for March 2021 - including Transformations API, Warehouse Syncs, and Audit Logs."
tags: ['rudderstack', 'product-launch', 'cdp', 'data']
draft: false
images: ['/images/blog/20210330-new-feature-roundup/hero.png']
authors: ['gavin-johnson']
---

**_This post was originally published on [RudderStack's blog](https://rudderstack.com/blog/new-feature-roundup-2021-03-3)._**
<br />
...
![Warehouse Syncs](/images/blog/20210330-new-feature-roundup/productroundupwarehousesyncs02.png)
...
![Audit Logs](/images/blog/20210330-new-feature-roundup/productroundupauditlog.png)
